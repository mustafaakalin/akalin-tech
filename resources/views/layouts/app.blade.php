...
<head>
    ...
    <title>@yield('title') - Akalın Tech</title>
...
<body class="bg-base-100 text-base-content">
    ...
    <main class="container mx-auto py-4 px-4">
            ...
            <div class="navbar  container mx-auto px-4 rounded-b-lg shadow-md">
                ...
                <div class="flex-1">
                    <a href="/" class="btn btn-ghost normal-case text-xl font-bold tracking-wider">
                        Akalın<span class="text-primary">Tech</span>
                    </a>
                </div>
        ...
        @yield('content')
        <!-- Footer -->
        <footer class="footer  text-white border-t border-gray-700 px-10 py-6">
            <div class="container mx-auto flex flex-col md:flex-row justify-between items-center">
                <aside class="flex items-center mb-4 md:mb-0">
                    <svg width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill-rule="evenodd"
                        clip-rule="evenodd" class="fill-current mr-2">
                        <path
                ...
                <nav class="flex space-x-4">
                    <a href="https://x.com/mustafa0x02" class="hover:text-primary transition duration-300 transform hover:scale-110">
                    ...
                    <a href="https://www.youtube.com/@mustafa0x02" class="hover:text-primary transition duration-300 transform hover:scale-110">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                            class="fill-current">
                            <path
                    ...
                    <a href="https://www.instagram.com/mustafa0x02/" class="hover:text-primary transition duration-300 transform hover:scale-110">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                            class="fill-current">
                            <path
